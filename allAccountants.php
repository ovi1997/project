...
$query = "SELECT * FROM users WHERE user_type='accountant'";
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">All Accountants</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                ...
                <?php foreach ($result as $class) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="post" onclick="return confirm('Are you sure?')" action="deleteAccountants.php?id=<?= $class['id'] ?>">
